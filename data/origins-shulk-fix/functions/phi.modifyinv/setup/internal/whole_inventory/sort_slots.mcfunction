...
function origins-shulk-fix:phi.modifyinv/setup/internal/whole_inventory/check_offhand
function origins-shulk-fix:phi.modifyinv/setup/internal/whole_inventory/check_armor
function origins-shulk-fix:phi.modifyinv/setup/internal/whole_inventory/check_inventory
function origins-shulk-fix:phi.modifyinv/setup/internal/whole_inventory/check_hotbar