...
data modify storage rx:io playerdb.player.data.eggohito.origins_shulk_fix.inv set from entity @s cardinal_components."apoli:powers".Powers[{Type: "origins:shulker_inventory"}].Data.Items
